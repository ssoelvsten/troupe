...
newtype RawVar = RawVar Ident deriving (Eq, Ord, Show)
...
ppFunDef (FunDef hfn consts insts _) =
    vcat
        [ text "func" <+> ppFunCall (ppId hfn) [] <+> text "{"
...
ppRawExpr (Bin binop _ va1 va2) =
    -- TODO: 2025-07-31; also print the fast flag
